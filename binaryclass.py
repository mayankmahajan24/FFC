...
def run_for_nomial_char_new(df, y_train_df, characteristic, useAdaBoost=False):
...
for characteristic in ['eviction' ,'layoff' ,'jobTraining']:
    ...
    pred = run_for_nomial_char_new(df, y_train_df, characteristic)
    print pred
    lr_prediction[characteristic] = pred

gen_submission(lr_prediction,"_lr")
